                ...
                <div class="col-md-4">
                     <div class="box">
							...
							<div class="box-body">
                                ...
                                All <strong>Blacklists</strong> can be found here: <strong><a href="http://www.dnsbl.info/dnsbl-list.php" target="_blank">http://www.dnsbl.info/dnsbl-list.php</a></strong>
                        	</div>
                     </div>
                     <div class="box">
                        	<div class="box-header">
