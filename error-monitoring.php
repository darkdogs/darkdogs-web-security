...
if (isset($_POST['ersave'])) {
    ...
    $esupdate = mysqli_query($connect, "UPDATE `$table` SET error_reporting='$ereporting', display_errors='$derrors'");
}
?>
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fa fa-exclamation-circle"></i> Error Monitoring</h1>
    			  <ol class="breadcrumb">
   			         <li><a href="dashboard"><i class="fa fa-home"></i> Admin Panel</a></li>
    			     <li class="active">Error Monitoring</li>
    			  </ol>
    			</section>
...
?>
                            <form method="post">
							    <label><i class="fa fa-bug"></i> Error Reporting</label>
...
?>>Report all PHP errors</option>
		                        ...
		                        <br />
								<label><i class="fa fa-eye"></i> Errors Visibility</label>
...
?>>Display Errors</option>
		                        ...
		                        <br />
		                        <input class="btn btn-primary btn-block" type="submit" name="ersave" value="Save" />
		                    </form>
						</div>
						</div>
				        ...
				        <div class="box">
						<div class="box-header">
							<h3 class="box-title">Error Monitoring</h3>
						</div>
						<div class="box-body">
<?php
...
?>
        ...
        <thead>
			<tr>
				<th><i class="fa fa-calendar-o"></i> Date & Time</th>
				<th><i class="fa fa-exclamation-circle"></i> Error</th>
			</tr>
		</thead>
        <tbody>
        <?php
