...
while ($row = mysqli_fetch_assoc($sql)) {
    echo '
										<tr>
										  ...
										  <td>
                                            <a href="log-details?id=' . $row['id'] . '" class="btn btn-flat btn-flat btn-primary"><i class="fa fa-tasks"></i> Details</a>
											';
    if (get_banned($row['ip']) == 'Yes') {
        echo '
										    <a href="bans-ip?delete-id=' . get_bannedid($row['ip']) . '" class="btn btn-flat btn-flat btn-success"><i class="fa fa-ban"></i> Unban</a>
									        ';
    } else {
        echo '
										    <a href="bans-ip?ip=' . $row['ip'] . '&reason=' . $row['type'] . '" class="btn btn-flat btn-flat btn-warning"><i class="fa fa-ban"></i> Ban</a>
									        ';
    }
    echo '
