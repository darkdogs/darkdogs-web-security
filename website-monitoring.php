...
if (isset($_GET['edit-id'])) {
    ...
    if (empty($id)) {
        echo '<meta http-equiv="refresh" content="0; url=website-monitoring">';
        exit();
    }
...
?></h3>
						...
						<div class="box-body">
										<div class="form-group">
											<label class="col-sm-2 control-label">Website Name / Domain: </label>
											<div class="col-sm-10">
...
<table id="dt-basic" class="table table-strdomained table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
						                  ...
						                  <th><i class="fa fa-server"></i> Website / Domain</th>
...
<form class="form-horizontal" action="" method="post">
				<div class="col-md-3">
				     <div class="box">
				        ...
				        <div class="box-body">
										<div class="form-group">
											<label class="col-sm-4 control-label">Website Name / Domain: </label>
											<div class="col-sm-8">
												<input name="domain" class="form-control" type="text" placeholder="website.com" required>
											</div>
										</div><br />
                                        <div class="form-group">
...
?>" width="97%" height="700px"></iframe></center>
                        ...
                        <div class="panel-footer">
							<a href="website-monitoring" class="btn btn-flat btn-success" name="edit-domain" type="submit"><i class="fa fa-sign-out"></i>
 Exit</a>
				        </div>
                     </div>
<?php
