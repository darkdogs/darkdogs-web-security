...
if (isset($_POST['save2'])) {
    ...
    $query = mysqli_query($connect, "UPDATE `$table` SET protection2='$protection2', protection3='$protection3', protection4='$protection4', protection5='$protection5', protection5='$protection5', protection6='$protection6', protection7='$protection7' WHERE id=1");
}
...
?> />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        Sanitization of all fields, inputs, forms and requests
                                        <br /><br /><br />
                                        <div class="switch switch-sm switch-success">
