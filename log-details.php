...
if (isset($_GET['id'])) {
    ...
    if (empty($id)) {
        echo '<meta http-equiv="refresh" content="0; url=all-logs">';
        exit();
    }
...
?></textarea>
                                        ...
                                        <div id="marker-map" style="height:450px"></div>
									</div>
...
<?php
    ...
    echo '
											<a href="all-logs?delete-id=' . $row['id'] . '" class="btn btn-flat btn-danger"><i class="fa fa-times"></i> Delete</a>
';
?>
									</div>
                     </div>
