...
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fa fa-align-justify"></i> All Logs</h1>
    			  <ol class="breadcrumb">
...
<?php
$table = $prefix . 'logs';
$sql   = mysqli_query($connect, "SELECT id, ip, date, browser, browser_code, os, os_code, country, country_code, type FROM `$table` ORDER by id DESC");
while ($row = mysqli_fetch_assoc($sql)) {
    ...
    if ($row['type'] == 'SQLi') {
        ...
        echo '
						                    <i class="fa fa-user-secret"></i> ' . $row['type'] . '
						                    ';
    }
    echo '
										  </td>
